...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import breakpad_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f16790e9-24a0-57e4-93e4-a31c5f47b348"))
platforms = [Pkg.Artifacts.unpack_platform(e, "breakpad", artifacts_toml) for e in artifacts["breakpad"]]
...
if best_platform === nothing
    @debug("Unable to load breakpad; unsupported platform $(triplet(platform_key_abi()))")
else
